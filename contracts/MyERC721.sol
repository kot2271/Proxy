 ...
 */
contract MyERC721 is Context, IERC165, IERC721, IERC721Metadata, Initializable {
    ...
    function mint(
        ...
        require(_initialOwner == msg.sender, "Only owner can mint");
    ...
    function burn(uint256 tokenId) external {
        require(_initialOwner == msg.sender, "Only owner can burn");
        require(_exists(tokenId), "Nonexistent token");
